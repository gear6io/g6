...
abstract final class EventKind {
  ...
  static const channelEventKinds = [
    deletion, // 5
    reaction, // 7
    nip29DeleteEvent, // 9005 — Gear6-native deletion
...
class NostrFilter {
  ...
  /// Gear6 relay bridge filter extensions (for example NIP-CW `top_level`).
...
/// Parse a Gear6 command response from the relay's OK message content.
///
