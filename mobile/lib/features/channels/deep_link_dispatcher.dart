...
/// Routes pending `g6://message` deep links into the channel view.
///
...
class _DeepLinkDispatcherState extends ConsumerState<DeepLinkDispatcher> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<Gear6DeepLink?>(pendingDeepLinkProvider, (_, link) {
      _maybeDispatch(link);
    });
  ...
  void _maybeDispatch(Gear6DeepLink? link) {
    if (link == null) return;
