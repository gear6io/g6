...
const _clientIdKeyPrefix = 'g6.nip-rs.client-id';
const _slotIdKeyPrefix = 'g6.nip-rs.slot-id';
const _uuid = Uuid();

String localReadStateKey(String pubkey) => 'g6.channel-read-state.v2:$pubkey';

String localPublishableContextKey(String pubkey) =>
    'g6.channel-read-state.publishable.v1:$pubkey';

String localSourceCreatedAtKey(String pubkey) =>
    'g6.channel-read-state.source-created-at.v1:$pubkey';
