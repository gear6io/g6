...
import 'package:g6/features/channels/deep_link_dispatcher.dart';
...
import 'package:g6/shared/deeplink/pending_deep_link_provider.dart';
...
void main() {
  ...
  testWidgets('prepares an invite once while listeners re-enter', (
    ...
    expect(find.text('Join this Gear6 community?'), findsOneWidget);
  });
...
class _RecordingPendingDeepLinkNotifier extends PendingDeepLinkNotifier {
  ...
  final Gear6DeepLink link;
  int consumeCalls = 0;

  @override
  Gear6DeepLink? build() => link;
