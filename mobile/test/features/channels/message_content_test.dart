...
import 'package:g6/features/channels/message_content.dart';
import 'package:g6/features/channels/media_viewer_page.dart';
  ...
  group('MessageContent', () {
    ...
    group('inline formatting', () {
      ...
      testWidgets('renders markdown link', (tester) async {
        await tester.pumpWidget(
          _testable(
            const MessageContent(content: 'Check [Gear6](https://example.com)'),
          ),
        );

        final allText = _allRichText(tester);
        expect(allText, contains('Gear6'));
        // Should not show raw markdown syntax.
        expect(allText, isNot(contains('[Gear6]')));
