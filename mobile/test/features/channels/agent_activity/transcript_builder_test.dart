...
import 'package:g6/features/channels/agent_activity/observer_models.dart';
import 'package:g6/features/channels/agent_activity/transcript_builder.dart';
...
void main() {
  ...
  test('normalizes g6 tool calls and applies result updates', () {
    final items = buildTranscript([
      _updateFrame(
        seq: 1,
        update: {
    ...
    expect(tool.g6ToolName, 'send_message');
  ...
  test('parses g6 prompt text into user message and metadata', () {
    final items = buildTranscript([
      ObserverFrame(
        seq: 1,
