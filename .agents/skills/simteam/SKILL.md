...
```bash
GEAR6_URL=$GEAR6_URL python3 .Codex/skills/simteam/check.py protocol
```
...
```bash
GEAR6_URL=$GEAR6_URL python3 .Codex/skills/simteam/seed.py $SP/cast.json \
...
```
You are <handle> on a software team. Read .Codex/skills/simteam/agent.md now;
...
```bash
GEAR6_URL=$GEAR6_URL python3 .Codex/skills/simteam/check.py audit $SP/cast.json
