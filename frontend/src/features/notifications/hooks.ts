...
const NOTIFICATION_SETTINGS_STORAGE_KEY = "g6-notification-settings.v2";
      ...
      if (nextPermission !== "granted") {
        ...
        setErrorMessage(
          nextPermission === "denied"
            ? "Desktop notifications are blocked for Gear6. Enable them in system settings to turn alerts on."
