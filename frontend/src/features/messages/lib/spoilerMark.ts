...
const SPOILER_MARKDOWN_RULE = "g6_spoiler";
const SPOILER_OPEN_TOKEN = "g6_spoiler_open";
const SPOILER_CLOSE_TOKEN = "g6_spoiler_close";
...
export function registerSpoilerMarkdownIt(
  ...
  md.renderer.rules[SPOILER_OPEN_TOKEN] = () =>
    '<span data-spoiler="" class="g6-spoiler">';
