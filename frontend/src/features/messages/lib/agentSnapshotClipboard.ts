...
const CLIPBOARD_ATTRIBUTE = "data-g6-agent-snapshot";
...
/** Build Gear6-specific clipboard HTML with the raw URL as its visible link. */
...
/** Convert a Gear6 snapshot clipboard payload into one pending attachment. */
