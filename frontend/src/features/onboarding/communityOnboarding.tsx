...
const STORAGE_KEY = "g6-community-onboarding-transaction.v1";
...
export function markCommunityOnboardingComplete(
  ...
  storage.setItem(
    `g6-community-onboarding-complete.v1:${encodeURIComponent(relayUrl)}:${pubkey}`,
    "true",
  );
  ...
  storage.setItem(`g6-onboarding-complete.v1:${pubkey}`, "true");
}
