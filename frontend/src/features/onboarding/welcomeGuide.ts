...
export const WELCOME_GUIDE_INTRO_MARKER = "g6-welcome-intro.v1";
...
export const WELCOME_GUIDE_INTRO_MESSAGE =
  "Hi, I'm Fizz. Welcome to Gear6.\n\nI can help you get oriented, answer questions, and make the first few steps feel less mysterious.\n\nFeel free to ask me what else you can do in Gear6, or just talk through what you want to build.";
