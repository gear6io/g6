          ...
          >
            <div className="relative w-full">
              <Input
                ...
                className="h-[3.6875rem] rounded-none border-0 bg-transparent px-10 text-center font-mono !text-4xl text-[color:var(--g6-onboarding-backup-ink)] shadow-none placeholder:text-foreground/30 focus-visible:ring-0"
        ...
        {previewNpub ? (
          variant === "spotlight" ? (
            ...
            >
              ...
              <p className="break-all font-mono text-[color:var(--g6-onboarding-backup-ink)]">
                {previewNpub}
              </p>
            </div>
          ) : (
