...
function RuntimeReadinessIndicator({
  ...
  return (
    <span
      aria-hidden="true"
      className="pointer-events-none absolute right-8 top-8 flex h-8 w-8 items-center justify-center rounded-full border border-[var(--g6-welcome-chartreuse)] bg-[var(--g6-welcome-chartreuse)]"
    ...
    return (
      <div className="flex flex-col items-center gap-1.5">
        <Button
          ...
          className="g6-onboarding-runtime-setup h-5 rounded-full bg-[var(--g6-welcome-chartreuse)]/30 px-2.5 font-mono !text-badge font-normal uppercase text-foreground hover:bg-[var(--g6-welcome-chartreuse)]/40"
    ...
    return (
      <>
        ...
        <p className="mt-1 text-xs leading-4 text-white">
          ...
          adapter. Older Gear6 releases using the legacy adapter contract may
    ...
    <section className="flex min-h-full w-full flex-col items-center">
      <div className="w-full max-w-[820px] text-center">
        ...
        <p className="mx-auto mt-3 max-w-[760px] text-sm leading-6 text-foreground/90">
          Gear6 detected the harnesses available on this machine. Install or sign
