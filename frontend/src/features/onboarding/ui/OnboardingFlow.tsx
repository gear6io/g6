...
export function OnboardingFlow({
  ...
  return (
    <>
      <div
        className="g6-onboarding-neutral-theme g6-startup-shell flex items-start justify-center overflow-y-auto bg-background px-4 pb-28 pt-[106px] text-foreground"
                  ...
                  {identityLost ? (
                    <>
                      ...
                      <p className="mt-5 text-sm leading-6 text-muted-foreground">
                        ...
                        Re-import your nsec to restore it — Gear6 will restart to
                    ...
                    <>
                      ...
                      <p className="mt-5 text-sm leading-6 text-muted-foreground">
                        ...
                        Gear6. If this key already has a profile on the relay,
