...
test("g6-acp wrapped auth failure → denied copy", () => {
...
test("unwrapped g6-agent prefix → denied copy", () => {
  // g6-agent's AgentError::LlmAuth Display is "llm auth: <body>"; if the
...
test("code -32001 → Gear6 shared compute denied copy (structured path)", () => {
