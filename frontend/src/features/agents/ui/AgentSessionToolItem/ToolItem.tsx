...
import { getGear6ToolInfo } from "../agentSessionToolCatalog";
...
export function ToolItem({
  ...
  const canonicalToolName = item.g6ToolName ?? item.toolName;
  const g6Tool = getGear6ToolInfo(canonicalToolName);
