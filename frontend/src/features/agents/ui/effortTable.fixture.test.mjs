 ...
 * matches every entry. Drift between `g6AgentConfig.ts` and the fixture
 * (e.g. a new model family added to one side but not the other) fails CI.
 * The companion Rust test in `crates/g6-agent/src/config.rs` mirrors
...
import { getProviderEffortConfig } from "./g6AgentConfig.ts";
