 ...
 * persona runtime string (e.g. `g6-agent`). A catalog lookup then returns
 ...
 *
 * - g6-agent / goose → "capable" (`isProviderCapable`, id-based).
 ...
 * persona (e.g. g6-agent/Anthropic). Persisting the local (empty) provider +
 ...
 *
 * MODEL follows the same transition rule. g6-agent/goose readiness requires a
