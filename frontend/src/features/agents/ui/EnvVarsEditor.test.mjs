...
test("inheritedRows_structured_keys_excluded_from_generic_rows", () => {
  // GEAR6_AGENT_PROVIDER, GEAR6_AGENT_MODEL, GEAR6_AGENT_THINKING_EFFORT must
  ...
  const allBaked = [
    ...
    { key: "GEAR6_AGENT_MODEL", value: "goose-claude-opus-4-8", masked: false },
    { key: "GEAR6_AGENT_THINKING_EFFORT", value: "medium", masked: false },
    {
      key: "DATABRICKS_HOST",
      value: "https://example.databricks.com/",
      masked: false,
