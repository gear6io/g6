 ...
 *  tree transitively imports a .css file (Gear6LogoAnimation.tsx →
 *  g6-logo-animation.css) and the test-loader has no CSS stub. The
...
// Gear6LogoAnimation.tsx → g6-logo-animation.css). The test below verifies the
