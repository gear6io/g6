      ...
      >
        ...
        {MODE_TAB_ORDER.map((tabMode) => (
          <TabsTrigger
            className={cn(
              isOnboardingModal
                ? "relative z-10 h-10 rounded-[6px] px-4 text-sm font-normal shadow-none transition-colors data-[state=active]:bg-[rgb(var(--g6-onboarding-avatar-action-bg))] data-[state=active]:text-[rgb(var(--g6-onboarding-avatar-action-fg))] data-[state=active]:shadow-none"
