...
const EMOJI_MART_SHADOW_CSS = `
  ...
  #root {
    --padding: var(--g6-emoji-picker-padding, 16px);
    --sidebar-width: 0px;
    display: flex;
  ...
  #root::after {
    background: linear-gradient(
      to bottom,
      rgba(var(--g6-emoji-picker-rgb-background), 0),
      rgba(var(--g6-emoji-picker-rgb-background), 0.98)
    );
    bottom: calc(var(--g6-emoji-picker-nav-button-size, 40px) + 24px);
    content: "";
    height: var(--g6-emoji-picker-fade-height, 0px);
    left: 0;
    opacity: var(--g6-emoji-picker-fade-opacity, 0);
    pointer-events: none;
    position: absolute;
    right: 0;
    z-index: 3;
  ...
  .scroll {
    ...
    padding-top: var(--g6-emoji-picker-scroll-padding-top, 28px);
    width: 100%;
  }
  ...
  .category button[data-g6-selected="true"] .background {
  ...
  #nav {
    ...
    flex: 0 0 auto;
    justify-content: space-between;
    padding: 8px var(--g6-emoji-picker-nav-padding-x, 24px) 16px;
  }
  ...
  #nav button {
    ...
    display: flex;
    flex: 0 0 var(--g6-emoji-picker-nav-button-size, 40px);
    height: var(--g6-emoji-picker-nav-button-size, 40px);
    justify-content: center;
    transition:
      background-color var(--duration) var(--easing),
      color var(--duration) var(--easing),
      transform var(--duration) var(--easing);
    width: var(--g6-emoji-picker-nav-button-size, 40px);
  }
  ...
  #nav svg,
  #nav img {
    height: var(--g6-emoji-picker-category-icon-size, 24px);
    width: var(--g6-emoji-picker-category-icon-size, 24px);
  }
`;
...
export function useEmojiMartStyles(
  ...
  React.useEffect(() => {
    ...
    const installEmojiMartStyles = () => {
      ...
      if (!shadowRoot.querySelector("#g6-emoji-mart-style")) {
        const style = document.createElement("style");
        style.id = "g6-emoji-mart-style";
...
export function useEmojiMartThemeVars() {
  ...
  React.useEffect(() => {
    const updateThemeVars = () => {
      ...
      setThemeVars({
        "--g6-emoji-picker-rgb-background": muted ?? "54, 58, 79",
        "--g6-emoji-picker-rgb-color": foreground ?? "245, 247, 255",
        "--g6-emoji-picker-rgb-input": background ?? "47, 51, 68",
