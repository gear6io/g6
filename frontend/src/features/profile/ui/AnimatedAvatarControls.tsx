...
export function AvatarFramingSlider({
  ...
  const sliderControl = (
    <div className="g6-avatar-framing-slider-wrapper">
      <div
        ...
        aria-valuemin={min}
        aria-valuenow={value}
        className="g6-avatar-framing-slider"
        ...
        style={
          {
            "--g6-avatar-framing-slider-fill": `${fill}%`,
          } as React.CSSProperties
        }
        tabIndex={disabled ? -1 : 0}
      >
        <div className="g6-avatar-framing-slider-hashmarks">
          {ticks.map((tick) => (
            <span
              aria-hidden="true"
              className="g6-avatar-framing-slider-hashmark"
              key={tick}
              style={{
        ...
        <div aria-hidden="true" className="g6-avatar-framing-slider-fill" />
        <div aria-hidden="true" className="g6-avatar-framing-slider-handle" />
      </div>
      <button
      ...
      {tipText ? (
        <p
          className="g6-avatar-framing-slider-tip"
