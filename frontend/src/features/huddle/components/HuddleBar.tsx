...
export function HuddleBar({
  ...
  return (
    <div
      ...
      className={cn(
        "g6-huddle-drawer grid min-w-0 grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-3 px-5 py-3 text-foreground",
    ...
    >
      ...
      <div className="flex items-center gap-5 justify-self-center">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                className="g6-huddle-control-button h-12 w-12 shrink-0 rounded-md"
              ...
              <TooltipTrigger asChild>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      "g6-huddle-control-button h-12 w-12 shrink-0 rounded-md",
        ...
        <Tooltip>
          ...
          <TooltipContent className="g6-huddle-tooltip">
            Leave huddle
          </TooltipContent>
        </Tooltip>
      </div>
