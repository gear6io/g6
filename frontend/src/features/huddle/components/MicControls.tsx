...
const splitChevronButtonClass =
  "g6-huddle-split-chevron group h-12 w-auto shrink-0 rounded-l-none px-2 py-4";
const MIC_PERMISSION_SETTINGS_URL =
  "x-apple.systempreferences:com.apple.preference.security?Privacy_Microphone";

type MicMeterBarStyle = CSSProperties & {
  "--g6-huddle-meter-height": string;
};
...
function micMeterBarStyle(heightRem: number): MicMeterBarStyle {
  return { "--g6-huddle-meter-height": `${heightRem}rem` };
}
    ...
    <Popover>
      ...
      >
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              className={cn(
                ...
                !isMuted && !micUnavailable && "g6-huddle-split-main",
              )}
              onClick={() => {
          ...
          <TooltipContent className="g6-huddle-tooltip" side="top">
            {micUnavailable
            ...
            {showMicMeter ? (
              ...
              >
                <span className="flex h-5 w-5 items-center justify-between text-current group-data-[state=open]:hidden group-focus-visible:hidden group-hover:hidden">
                  <span
                    className="g6-huddle-mic-meter-bar bg-current"
      ...
      <PopoverContent
        side="top"
        className="g6-huddle-drawer g6-huddle-popover w-64 text-foreground"
      >
      ...
      <div className="relative flex items-center">
        ...
        >
          ...
          <PopoverContent
            ...
            className="g6-huddle-drawer g6-huddle-popover g6-huddle-headphones-hint w-64 p-3 text-foreground"
        ...
        <Button
          ...
          className={cn(
            splitIconButtonClass,
            ttsEnabled && "g6-huddle-split-main",
          )}
          onClick={onToggleTts}
          size="icon"
