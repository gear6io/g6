...
export const chromeCssVars = {
  topChromeHeight: "--g6-top-chrome-height",
  channelContentTopPadding: "--g6-channel-content-top-padding",
} as const;
...
export const topChromeBackdrop = {
  ...
  height: "h-(--g6-top-chrome-height,40px)",
  /** `after:` pseudo-element offset aligned to the bottom of top chrome. */
  dividerTop: "after:top-(--g6-top-chrome-height,40px)",
} as const;
...
export const channelChrome = {
  ...
  contentPadding: "pt-(--g6-channel-content-top-padding,5.75rem)",
  /** Absolute/fixed top offset below the measured channel header chrome. */
  top: "top-(--g6-channel-content-top-padding,5.75rem)",
  /** Height matching the measured channel header chrome. */
  headerHeight: "h-(--g6-channel-content-top-padding,5.75rem)",
  /** Negative margin for overlaid channel chrome that should not affect flow. */
  negativeMargin: "-mb-(--g6-channel-content-top-padding,5.75rem)",
} as const;
