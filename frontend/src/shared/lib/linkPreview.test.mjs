...
test("parseSupportedLinkPreview parses Linear issue URLs", () => {
  assert.deepEqual(
    parseSupportedLinkPreview(
      "https://linear.app/g6/issue/BUG-321/fix-link-previews",
    ),
    {
      kind: "linear-issue",
      href: "https://linear.app/g6/issue/BUG-321/fix-link-previews",
      provider: "Linear",
      title: "BUG-321",
      typeLabel: "issue",
    },
...
test("parseSupportedLinkPreview normalizes Linear issue URL variants", () => {
  assert.deepEqual(
    parseSupportedLinkPreview("linear.app/g6/issue/a-7/fix-link-previews"),
    {
      kind: "linear-issue",
      href: "https://linear.app/g6/issue/a-7/fix-link-previews",
      provider: "Linear",
      title: "A-7",
      typeLabel: "issue",
    },
  ...
  assert.deepEqual(
    extractSupportedLinkPreviews(
      [
        ...
        "and https://linear.app/g6/issue/BUG-2/fix-preview",
  ...
  assert.deepEqual(
    extractSupportedLinkPreviews(
      [
        ...
        "```",
        "https://linear.app/g6/issue/BUG-2/fix-preview",
        "```",
  ...
  assert.deepEqual(
    extractSupportedLinkPreviews(
      [
        "||",
        "",
        "https://linear.app/g6/issue/BUG-99/hidden-spoiler-link",
        "",
        "||",
