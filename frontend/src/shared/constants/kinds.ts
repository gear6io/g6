...
// Gear6-native deletion. The relay soft-deletes the target and emits a
...
// Tag shapes are pinned by g6-sdk builders + relay moderation_commands.rs.
...
// to all three to patch local records. Mirror of g6-core's KIND_PERSONA etc.
...
// Keep this in sync with the Home-feed mention query in g6-db.
...
export const CHANNEL_EVENT_KINDS = [
  ...
  KIND_NIP29_DELETE_EVENT, // 9005 — NIP-29 / Gear6-native deletions
