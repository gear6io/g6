      ...
      >
        <DialogPrimitive.Content
          className={cn(
            ...
            surface === "textured" &&
              "g6-card-textured isolate box-border w-full rounded-none border-0 bg-transparent p-[var(--g6-card-textured-safe-inset)] shadow-none",
            MODAL_CONTENT_MOTION_CLASS,
            className,
          )}
          ref={ref}
          ...
          {showCloseButton ? (
            <DialogPrimitive.Close
              className={cn(
                ...
                surface === "textured"
                  ? "right-[var(--g6-card-textured-safe-inset)] top-[var(--g6-card-textured-safe-inset)] -mr-2 -mt-2"
                  : "right-4 top-4",
                closeButtonClassName,
              )}
            >
