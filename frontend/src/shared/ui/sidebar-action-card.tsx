...
function SidebarActionDescriptionText({
  ...
  if (shouldReduceMotion || !transition.isAnimating) {
    return (
      <span className="g6-sidebar-action-description">
        {transition.current}
      </span>
    );
  }
  ...
  return (
    <span className="g6-sidebar-action-description">
      ...
      <span aria-hidden className="g6-sidebar-action-description__motion">
        <span
          className="g6-sidebar-action-description__reel"
    ...
    >
      <button
        ...
        className={cn(
          ...
          isSuccess
            ? "g6-sidebar-action-card--success disabled:cursor-default disabled:opacity-100"
            : surface === "secondary"
      ...
      >
        ...
        <motion.span
          className={cn(
            ...
            isSuccess
              ? "g6-sidebar-action-card__success-icon"
