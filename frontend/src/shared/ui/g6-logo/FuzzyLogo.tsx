...
import Gear6LogoAnimation, {
  type Gear6LogoAnimationProps,
} from "./Gear6LogoAnimation";
...
export type FuzzyLogoProps = {
  ...
  pulse?: boolean;
  reverse?: boolean;
  variant?: Gear6LogoAnimationProps["variant"];
};

/**
 * The fuzzy Gear6 mark. v8 ships a built-in animated texture (looping fractal-noise
...
export function FuzzyLogo({
  ...
  return (
    <Gear6LogoAnimation
      ariaLabel={ariaLabel}
      className={cn(
        pulse && !fuzz && !hasRestWindow && "g6-logo--pulse",
        className,
      )}
      fullScreen={false}
      loop={loop}
