...
/**
 * The Gear6 bee mark with flapping wings. Geometry is identical to the static
 * {@link Gear6Mark} (v8 final keyframe) — the same silhouette, rendered in
 * `currentColor` so it tints per-theme — with the wing-flap keyframes (ported
 * from the Gear6 website) beating the wings on an infinite loop.
 *
