 ...
 * - Default padding is the safe inset (`--g6-card-textured-safe-inset`),
  ...
  variants: {
    variant: {
      ...
      textured:
        ...
        "g6-card-textured relative isolate flex flex-col justify-center rounded-none border-0 p-[var(--g6-card-textured-safe-inset)] shadow-none",
    },
  },
  defaultVariants: {
    variant: "default",
