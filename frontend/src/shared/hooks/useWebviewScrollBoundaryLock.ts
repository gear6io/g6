...
const CONVERSATION_SCROLL_SELECTOR = "[data-g6-conversation-scroll]";
 ...
 *
 * Gear6 is laid out as fixed-height nested panes. On macOS, a wheel/trackpad
 ...
 * boundaries, only containers marked with `data-g6-conversation-scroll` are
