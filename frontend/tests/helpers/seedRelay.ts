...
// (g6-relay/src/handlers/ingest.rs). Eva's channel-window surface reads that
...
//
// Transport auth: the test relay runs GEAR6_REQUIRE_AUTH_TOKEN=false
...
//
// Canonical tag shapes (crates/g6-sdk/src/builders.rs thread_tags + ingest):
