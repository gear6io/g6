...
//!
//! When `GEAR6_BUILD_AGENT_METRIC_ARCHIVE_DEFAULT` is set at build time
...
pub fn agent_metric_archive_default_enabled() -> bool {
    option_env!("GEAR6_DESKTOP_BUILD_AGENT_METRIC_ARCHIVE_DEFAULT").is_some()
}
...
mod tests {
    ...
    fn test_agent_metric_archive_default_enabled_returns_false_in_oss_build() {
        // In a standard OSS/test build (no GEAR6_DESKTOP_BUILD_AGENT_METRIC_ARCHIVE_DEFAULT
