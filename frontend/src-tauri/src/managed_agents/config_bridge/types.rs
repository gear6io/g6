...
pub enum ConfigOrigin {
    /// Explicitly set in Gear6 UI / ManagedAgentRecord (highest precedence).
    Gear6Explicit,
    ...
    /// re-tag injected fields from `Gear6Explicit` to `PersonaDefault`.
    PersonaDefault,
    ...
    /// the linked persona specifies a value. Re-tagged from `Gear6Explicit` by the
