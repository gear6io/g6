...
<head>
  ...
  <title>Gear6 authentication complete</title>
  <style>
    :root {
      color-scheme: light;
...
<body>
  <main>
    <svg class="bee" viewBox="0 0 466 309" role="img" aria-label="Gear6">
      <defs>
        <mask id="bee-mask">
    ...
    <p>You can close this window and return to Gear6.</p>
  </main>
</body>
</html>"#;
...
pub(crate) async fn get_builderlab_nostr_identity(
    ...
    authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/g6/nostr-identities/current",
        serde_json::json!({}),
    )
    .await
}
...
pub(crate) async fn bind_builderlab_nostr_identity(
    ...
    let challenge_value = authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/g6/nostr-identities/challenge",
...
pub(crate) async fn check_builderlab_community_name(
    ...
    authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/g6/communities/availability",
...
mod tests {
    ...
    #[test]
    fn auth_complete_page_uses_g6_brand() {
        for expected in [
            "<title>Gear6 authentication complete</title>",
            "#d7d72e",
            "#231e1e",
    ...
    fn login_defaults_to_auth0_login() {
        ...
        assert_eq!(query.get("product").map(String::as_str), Some("g6"));
        assert_eq!(
