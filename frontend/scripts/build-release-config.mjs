...
//    Both GEAR6_UPDATER_PUBLIC_KEY and GEAR6_UPDATER_ENDPOINT are required -
...
const updaterPubkey = process.env.GEAR6_UPDATER_PUBLIC_KEY;
const updaterEndpoint = process.env.GEAR6_UPDATER_ENDPOINT;

const missing = [];
if (!updaterPubkey) missing.push("GEAR6_UPDATER_PUBLIC_KEY");
if (!updaterEndpoint) missing.push("GEAR6_UPDATER_ENDPOINT");
if (missing.length > 0) {
  console.error(
